...
(\textasciitilde$10^4$--$10^6$ бит/с) & Среднее & Низкая & Средняя (зависит от
...
(\textasciitilde$10^6$--$10^8$ бит/с) & Высокое & Средняя--высокая &
...
(дискретные события)} & Очень высокая (\textasciitilde$10^6$--$10^9$ бит/с) &
